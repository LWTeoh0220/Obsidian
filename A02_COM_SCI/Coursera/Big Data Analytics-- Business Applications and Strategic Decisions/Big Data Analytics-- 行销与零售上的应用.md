...
## 零售卖场案例
- 争对关联分析，自动寻找出最具**关联性**的购买商品
	具关联性的商品进行搭售与联合促销
	寄送另一商品的促销讯息给只够买单一商品者
	高度相关商品陈列在相邻区域 【两种说法，陈列在近处（加强观点） or 陈列在远处（平衡观点）】
- 针对特性关联性最高的栏位
	可进行目标行销：统一寄送到特定客群，降低行销成本
...
##### 目标行销
- 从会员资料与购买记录中，找出会员与商品之间的关联性
- 从会员资料与购买记录中，寻找会员的连续购买行为

##### 直效行销
- 针对目标族群寄送行销讯息 —— 成本更低、回应率更高
- 预测消费购买行为、刺激消费 —— 增加营收
- 辨识目标族群，加以行销扩散


![[Pasted image 20260315174528.png]]
## 线上零售（电子商务）案例
- 针对 **访客数（流量）、转换率、客单价**提升业绩

##### 会员分群
- 目的：了解现况、指定会员经营策略
- 潜力用户、流失用户、活跃用户
![[Pasted image 20260315175530.png]]
